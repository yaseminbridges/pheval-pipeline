...
workflow {
    exo_ch     = Channel.fromList(params.exomiser_configs) | prepare_exomiser_input
    corpora_ch = Channel.fromList(params.corpora_configs)  | prepare_corpora

    exo_ch.combine(corpora_ch) | run_pheval
}